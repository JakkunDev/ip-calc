...
$ sudo make all
```
**after done with that, ipcalc has been successfully added to your linux machine commands**
...
```
-h or --help                     Displays info about available options and version of software.
